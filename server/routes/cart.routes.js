...
cartRouter.get(
  "/customer/:id",
  tokenVerification,
  cartController.readCartByCustomer,
);
...
cartRouter.post(
  "/product",
  tokenVerification,
  cartController.createNewCartProduct,
);
cartRouter.put(
  "/product",
  tokenVerification,
  cartController.updateExistingCartProduct,
);
cartRouter.delete(
  "/product",
  tokenVerification,
  cartController.deleteExistingCartProduct,
);
...
cartRouter.get(
  ...
  cartController.readAllCart,
);
cartRouter.get(
  "/:id",
  tokenVerification,
  adminVerification(ADMIN_ROLE),
  cartController.readCartById,
);
